...
proc finish {} {
	...
	#exec xgraph tp1.tr -color 2 tp2.tr -color 3 tp_total.tr -color 4 cwnd1.tr -color 5 cwnd2.tr -color 6 q_size.tr -color 7 &
        exec xgraph tp1.tr tp2.tr tp3.tr tp_total.tr cwnd1.tr cwnd2.tr cwnd3.tr q_size.tr -geometry 800x400  &
...
proc record {} {
        global tcp0 tcp1 tcp2 sink0 sink1 sink2 f0 f1 f2 f3 f4 f5 f6 f7 qmon
