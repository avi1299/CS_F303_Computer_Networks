...
set f0 [open tp1.tr w]
set f1 [open tp2.tr w]
set f2 [open cwnd1.tr w]
set f3 [open cwnd2.tr w]
set f4 [open tp_total.tr w]
set f5 [open q_size.tr w]
...
proc finish {} {
	global ns f0 f1 f2 f3 f3 f4 f5 nf tf
	...
	#exec xgraph tp1.tr -color 2 tp2.tr -color 3 tp_total.tr -color 4 cwnd1.tr -color 5 cwnd2.tr -color 6 q_size.tr -color 7 &
        exec xgraph tp1.tr tp2.tr tp_total.tr cwnd1.tr cwnd2.tr q_size.tr -geometry 800x400  &
...
proc record {} {
        global tcp0 tcp1 sink0 sink1 f0 f1 f2 f3 f4 f5 qmon
	...
	#Calculate the bandwidth (in MBit/s) and write it to the files
        ...
        puts $f2 "$now [expr ($bw0+$bw1)/$time*8/1000000]"
        puts $f3 "$now [expr $cw0/$time*8/1000]"
        puts $f4 "$now [expr $cw1/$time*8/1000]"
