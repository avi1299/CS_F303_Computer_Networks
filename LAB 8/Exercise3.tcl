...
proc finish {} {
	global ns f0 f1 f2 f3 tf nf tp1 tp2
        puts "TCP traffic throughput= [expr $tp1*8/1000/29] Kbit/s"
        puts "UDP traffic throughput= [expr $tp2*8/1000/29] Kbit/s"
...
proc record {} {
        global tcp0 udp0 sink0 sink1 f0 f1 f2 f3 tp1 tp2
	...
	#How many bytes have been received by the traffic sinks?
        ...
        #set tp1 [expr $tp1 + $bw0]
        #set tp2 [expr $tp2 + $bw1]
        incr tp1 $bw0
        incr tp2 $bw1
	...
	#Calculate the bandwidth (in MBit/s) and write it to the files
        ...
        puts $f3 "$now [expr $cw1/$time*8/1000]"
